...
import resumePDF from './assets/Carlos_Rojas Resume_t.pdf'
              ...
              <Container maxWidth="md" className="container">
                <Grid container>
                  <Grid item xs={12} sm={5}>
                    <img src={profile} alt="Carlos" id={"carlos"} className="profile" />
                  </Grid>
                  ...
                  <Grid container>
                    ...
                    <Grid item xs={12} sm={12}>
                      <hr />
                      <Typography variant="h4" id={"resume"} style={{ paddingTop: '20px', fontFamily: 'Coda, sans-ser' }}>Resume</Typography>
                    ...
                    <Grid item xs={12} sm={12}>
                      <Typography variant="h4" id={"portfolio"} style={{ paddingTop: '20px', fontFamily: 'Coda, sans-ser' }}>Portfolio</Typography>
                    </Grid>
                    ...
                    <br />
                    {
                      fullStack
                        ? (<Grid item xs={12} lg={12}>
                          <PortfolioCard image={treeHouseClub} title={"Tree House Club"} gitHub={'https://github.com/Carlos-Rojas-CA/Tree-House'} site={'https://tree-house-club.herokuapp.com/'} details={"Tree House Club is an organization app for those looking to find a new rental property. A user is able to copy and paste a link from Craigslist after creating a profile and club to create a house card. This card shows the photos and basic information for the property. By doing so, they may nagivate listings they like as well as view the description posted on the website. The driving force behind this website is students and friends have to organize listings by sending them to each other through instant messages and don't have an idea which linked they 'liked'. A soon-to-be feature would be to allow multiple users edit and like listings from a shared Club. This website is built with a MERN stack, TypeScript, and Puppeteer."} />
